...
class OpenRouterClient:
    ...
    # Modelos gratuitos recomendados con información de contexto
    FREE_MODELS = {
        ...
        "microsoft/phi-3-mini-128k-instruct:free": {
            ...
            "context": "128K tokens", 
            "reasoning": False,
            "description": "Modelo compacto con gran ventana de contexto"
        },
        "meta-llama/llama-3.2-3b-instruct:free": {
            "name": "Llama 3.2 3B",
            "context": "128K tokens",
            "reasoning": False,
            "description": "Modelo eficiente de Meta con buen rendimiento"
        },
        "qwen/qwen-2.5-7b-instruct:free": {
            "name": "Qwen 2.5 7B",
            "context": "32K tokens",
            "reasoning": False,
            "description": "Modelo multilingüe avanzado de Alibaba"
        },
        "huggingfaceh4/zephyr-7b-beta:free": {
            "name": "Zephyr 7B Beta", 
            "context": "32K tokens",
            "reasoning": False,
            "description": "Modelo optimizado para seguimiento de instrucciones"
        }
    }
